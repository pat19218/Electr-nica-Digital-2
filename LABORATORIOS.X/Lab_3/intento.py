...
class GroupClass(QGroupBox):
    ...
    def connect(self):
        ...
        #with serial.Serial(self.typeBox.currentText(), 9600, timeout=1) as self.serial:
        if self.serial is None:
            self.serial=serial.Serial(self.typeBox.currentText(), 9600, timeout=1)
            time.sleep(0.01)
